bg_dark        = "rgb(0b120c)"       -- Deep dark green/black base
circuit_green  = "rgb(39ff14)"       -- Neon glowing circuit green
circuit_dim    = "rgb(154a1d)"       -- Muted circuit green
flame_core     = "rgb(ffee00)"       -- Bright core yellow
flame_outer    = "rgb(ff8800)"       -- Burning orange
